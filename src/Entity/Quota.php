...
class Quota extends AbstractEntity
{
    protected static $fields = [
        ...
        'close_when_sold_out' => 'boolean', // If true, the quota will “close” as soon as it is sold out once. Even if tickets become available again, they will not be sold unless the quota is set to open again.
